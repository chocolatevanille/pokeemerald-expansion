...
const u8 gText_TeamPreview[] = _("Opponent's Team Preview.");
...
const u8 gText_PPMax4BP[] = _("PP MAX{CLEAR_TO 0x64}4BP");
const u8 gText_AbilityShield16BP[] = _("ABILITY SHIELD{CLEAR_TO 0x5E}16BP");
const u8 gText_SafetyGoggles16BP[] = _("SAFETY GOGGLES{CLEAR_TO 0x5E}16BP");
const u8 gText_ShedShell16BP[] = _("SHED SHELL{CLEAR_TO 0x5E}16BP");
const u8 gText_ShellBell16BP[] = _("SHELL BELL{CLEAR_TO 0x5E}16BP");
const u8 gText_WeaknessPolicy16BP[] = _("WEAKNESS POLICY{CLEAR_TO 0x5E}16BP");
const u8 gText_AirBalloon32BP[] = _("AIR BALLOON{CLEAR_TO 0x5E}32BP");
const u8 gText_ClearAmulet32BP[] = _("CLEAR AMULET{CLEAR_TO 0x5E}32BP");
...
const u8 gText_SitrusBerry48BP[] = _("SITRUS BERRY{CLEAR_TO 0x5E}48BP");
const u8 gText_SalacBerry48BP[] = _("SALAC BERRY{CLEAR_TO 0x5E}48BP");
const u8 gText_AssaultVest64BP[] = _("ASSAULT VEST{CLEAR_TO 0x5E}64BP");
const u8 gText_FocusSash64BP[] = _("FOCUS SASH{CLEAR_TO 0x5E}64BP");
const u8 gText_RockyHelmet64BP[] = _("ROCKY HELMET{CLEAR_TO 0x5E}64BP");
const u8 gText_LoadedDice16BP[] = _("LOADED DICE{CLEAR_TO 0x5E}16BP");
const u8 gText_ProtectivePads16BP[] = _("PROTECTIVE PADS{CLEAR_TO 0x5E}16BP");
const u8 gText_PunchingGlove16BP[] = _("PUNCHING GLOVE{CLEAR_TO 0x5E}16BP");
const u8 gText_ExpertBelt32BP[] = _("EXPERT BELT{CLEAR_TO 0x5E}32BP");
const u8 gText_ThroatSpray32BP[] = _("THROAT SPRAY{CLEAR_TO 0x5E}32BP");
const u8 gText_WhiteHerb48BP[] = _("WHITE HERB{CLEAR_TO 0x5E}48BP");
const u8 gText_PowerHerb48BP[] = _("POWER HERB{CLEAR_TO 0x5E}48BP");
...
const u8 gText_ElectricSeed16BP[] = _("ELECTRIC SEED{CLEAR_TO 0x5E}16BP");
const u8 gText_GrassySeed16BP[] = _("GRASSY SEED{CLEAR_TO 0x5E}16BP");
const u8 gText_MistySeed16BP[] = _("MISTY SEED{CLEAR_TO 0x5E}16BP");
const u8 gText_PsychicSeed16BP[] = _("PSYCHIC SEED{CLEAR_TO 0x5E}16BP");
const u8 gText_TerrainExtender32BP[] = _("TERRAIN EXTENDER{CLEAR_TO 0x5E}32BP");
const u8 gText_BoosterEnergy80BP[] = _("BOOSTER ENERGY{CLEAR_TO 0x5E}80BP");
const u8 gText_SoulDew100BP[] = _("SOUL DEW{CLEAR_TO 0x5E}100BP");
