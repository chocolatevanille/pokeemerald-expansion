...
extern const u8 gText_PPMax4BP[];

extern const u8 gText_AbilityShield16BP[];
extern const u8 gText_SafetyGoggles16BP[];
extern const u8 gText_ShedShell16BP[];
extern const u8 gText_ShellBell16BP[];
extern const u8 gText_WeaknessPolicy16BP[];
extern const u8 gText_AirBalloon32BP[];
extern const u8 gText_ClearAmulet32BP[];
extern const u8 gText_Leftovers48BP[];
extern const u8 gText_MentalHerb48BP[];
extern const u8 gText_SitrusBerry48BP[];
extern const u8 gText_SalacBerry48BP[];
extern const u8 gText_AssaultVest64BP[];
extern const u8 gText_FocusSash64BP[];
extern const u8 gText_RockyHelmet64BP[];

extern const u8 gText_LoadedDice16BP[];
extern const u8 gText_ProtectivePads16BP[];
extern const u8 gText_PunchingGlove16BP[];
extern const u8 gText_ExpertBelt32BP[];
extern const u8 gText_ThroatSpray32BP[];
extern const u8 gText_WhiteHerb48BP[];
extern const u8 gText_PowerHerb48BP[];
...
extern const u8 gText_ElectricSeed16BP[];
extern const u8 gText_GrassySeed16BP[];
extern const u8 gText_MistySeed16BP[];
extern const u8 gText_PsychicSeed16BP[];
extern const u8 gText_TerrainExtender32BP[];
extern const u8 gText_BoosterEnergy80BP[];
extern const u8 gText_SoulDew100BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SitrusBerryDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ProtectivePadsDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ElectricSeedDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GrassySeedDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MistySeedDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_PsychicSeedDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SoulDewDesc[];
